...
- Binary: `D:\Projects_1\POS_Enterprise_DotNet\src\POS.Wpf\bin\Release\net10.0-windows\POS.Enterprise.exe`; `POS.Enterprise.dll` SHA-256 `150C9900A5751529E7B6111C34BCA326591AD521E6B1C96D6F8F9A5068BADAE2`, MVID `753ef713-da14-410d-83ed-67a102d3343f`, LastWriteTime `2026-09-04T21:14:41.7726311+07:00`. No real database was accessed or updated. Product Owner manual retest passed the documented normal/maximized Supplier UI checks; DPI 125/150, physical UI, InventoryStaff/Cashier click-through and physical audit/hardware remain deferred.
