...
- Current checkpoint: R2.1 — Single-instance Application — COMPLETE. R2.2 — SQLite Busy/Locked UX is next and Not Started. R1 remains Closed at `b9e382550e2e4abcf7a93ed6c5352322dc967668`.
...
- R1.3 and R1 are Closed at `b9e382550e2e4abcf7a93ed6c5352322dc967668`. R2.1 is COMPLETE: database-scoped ownership/activation implementation, Release rebuild, 992/992 full tests, Quality Gate/vulnerability/EF/security checks and manual Tests A/B/C/D PASS. R2.2–R2.4 remain Not Started.
...
Context Packs remain export-only under ignored `artifacts/project-context/`. R2.1 implementation, automated single-instance tests, crash recovery and foreground activation acceptance are complete. The next checkpoint is R2.2 — SQLite Busy/Locked UX; it has not started.
